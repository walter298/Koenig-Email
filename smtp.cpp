...
int main(void) {
    std::string workingDirectory = "D:/C++_Projects_V2/Merck_Email/Merck_Email";
    ...
    email.sender = "waltersteinsmith@gmail.com";
    email.password = "mbes wgkm cgxl mift";
    email.certPath = workingDirectory + "/cacert.pem";
    email.recipients = { "jamesrichards130@yahoo.com", "steinsmithw@carleton.edu" };
    email.ccRecipients = { "walterstein456@gmail.com" };
